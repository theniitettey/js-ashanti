              ...
              {items.map((product, productIdx) => (
                <li key={product.id} className="flex py-6 sm:py-10">
                  ...
                  <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
                      ...
                      <div>
                        <div className="flex justify-between">
                          <h3 className="text-sm">
                            <Link href="#" className="font-medium dark:text-gray-200 dark:hover:text-gray-300">
                              {product.name}
                            </Link>
                          </h3>
                        </div>
                        <p className="mt-1 text-sm font-medium dark:text-gray-200">
                          GH₵{product.price.toFixed(2)} x {product.quantity} = GH₵{(product.price * product.quantity).toFixed(2)}
                        </p>
                      </div>
                    ...
                    <p className="mt-4 flex space-x-2 text-sm dark:text-gray-200">
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd className="text-sm font-medium text-gray-900">GH₵{shipping.toFixed(2)}</dd>
              </div>
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                ...
                <dd className="text-base font-medium text-gray-900">GH₵{total.toFixed(2)}</dd>
              </div>
            </dl>
