  ...
  return (
    ...
    border-b border-white/20 shadow-sm md:rounded-full"
      >
        ...
        <div
          className={`md:hidden overflow-hidden transition-all duration-300 ease-in-out bg-white dark:bg-black dark:text-white shadow-inner ${isOpen ? "h-dvh py-4 w-1/2" : "max-h-0 opacity-0 w-1/2"
            }`}
        >
